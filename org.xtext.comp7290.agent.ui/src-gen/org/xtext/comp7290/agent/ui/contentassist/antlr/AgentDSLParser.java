 ...
 * generated by Xtext
 */
package org.xtext.comp7290.agent.ui.contentassist.antlr;
...
public class AgentDSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.comp7290.agent.ui.contentassist.antlr.internal.InternalAgentDSLParser createParser() {
		org.xtext.comp7290.agent.ui.contentassist.antlr.internal.InternalAgentDSLParser result = new org.xtext.comp7290.agent.ui.contentassist.antlr.internal.InternalAgentDSLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTaskAccess().getAttributesAssignment_3(), "rule__Task__AttributesAssignment_3");
					put(grammarAccess.getTaskAccess().getOutcomeAssignment_4(), "rule__Task__OutcomeAssignment_4");
					put(grammarAccess.getOutcomeAccess().getNameAssignment_1(), "rule__Outcome__NameAssignment_1");
					put(grammarAccess.getOutcomeAccess().getAttributesAssignment_3(), "rule__Outcome__AttributesAssignment_3");
					put(grammarAccess.getOutcomeAccess().getGoalAssignment_4(), "rule__Outcome__GoalAssignment_4");
					put(grammarAccess.getGoalAccess().getNameAssignment_1(), "rule__Goal__NameAssignment_1");
					put(grammarAccess.getGoalAccess().getAttributesAssignment_3(), "rule__Goal__AttributesAssignment_3");
					put(grammarAccess.getFunctionAccess().getNameAssignment_1(), "rule__Function__NameAssignment_1");
					put(grammarAccess.getFunctionAccess().getAttributesAssignment_3(), "rule__Function__AttributesAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.comp7290.agent.ui.contentassist.antlr.internal.InternalAgentDSLParser typedParser = (org.xtext.comp7290.agent.ui.contentassist.antlr.internal.InternalAgentDSLParser) parser;
