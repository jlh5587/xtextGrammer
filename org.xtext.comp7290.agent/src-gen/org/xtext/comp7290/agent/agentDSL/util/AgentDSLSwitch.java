 ...
 * @generated
 */
public class AgentDSLSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case AgentDSLPackage.TASK:
      {
        Task task = (Task)theEObject;
        T result = caseTask(task);
        if (result == null) result = caseType(task);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case AgentDSLPackage.OUTCOME:
      {
        Outcome outcome = (Outcome)theEObject;
        T result = caseOutcome(outcome);
        if (result == null) result = caseType(outcome);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case AgentDSLPackage.GOAL:
      {
      ...
      case AgentDSLPackage.ATTRIBUTE:
      {
