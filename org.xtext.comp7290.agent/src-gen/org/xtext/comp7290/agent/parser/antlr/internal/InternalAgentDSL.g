...
@parser::members {
    ...
    public InternalAgentDSLParser(TokenStream input, AgentDSLGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected AgentDSLGrammarAccess getGrammarAccess() {
...
(
    ...
    |
    { 
        newCompositeNode(grammarAccess.getTypeAccess().getTaskParserRuleCall_2()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getTypeAccess().getOutcomeParserRuleCall_3()); 
    }
    this_Outcome_3=ruleOutcome
    { 
        $current = $this_Outcome_3.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getTypeAccess().getFunctionParserRuleCall_4()); 
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTaskAccess().getAttributesAttributeParserRuleCall_3_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTaskAccess().getOutcomeOutcomeParserRuleCall_4_0()); 
	    }
		lv_outcome_4_0=ruleOutcome		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTaskRule());
	        }
       		set(
...
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getOutcomeAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getOutcomeAccess().getLeftCurlyBracketKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getOutcomeAccess().getAttributesAttributeParserRuleCall_3_0()); 
	    }
		lv_attributes_3_0=ruleAttribute		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getOutcomeAccess().getGoalGoalParserRuleCall_4_0()); 
	    }
		lv_goal_4_0=ruleGoal		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getOutcomeRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getOutcomeAccess().getRightCurlyBracketKeyword_5());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getGoalAccess().getAttributesAttributeParserRuleCall_3_0()); 
	    }
		lv_attributes_3_0=ruleAttribute		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getFunctionAccess().getAttributesAttributeParserRuleCall_3_0()); 
	    }
		lv_attributes_3_0=ruleAttribute		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getFunctionAccess().getRightCurlyBracketKeyword_4());
    }
)
;
