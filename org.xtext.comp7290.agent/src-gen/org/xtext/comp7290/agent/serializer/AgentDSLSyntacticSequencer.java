...
public class AgentDSLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected AgentDSLGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (AgentDSLGrammarAccess) access;
